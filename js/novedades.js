...
// ==== Utilidades ====
function showToast(mensaje) { alert(mensaje); }
...
async function cargarDia(fecha) {
    ...
    datosEnPantalla = {
        ...
        expulsados: docSnap.data().expulsados || [],
        frustradas: docSnap.data().frustradas || [],
        fletados: docSnap.data().fletados || [],
        fletadosFuturos: docSnap.data().fletadosFuturos || [],
        conduccionesPositivas: docSnap.data().conduccionesPositivas || [],
        conduccionesNegativas: docSnap.data().conduccionesNegativas || [],
        pendientes: docSnap.data().pendientes || []
    };
    refrescarTodo();
}
...
// ==== Añadir datos (todos los formularios actualizan solo datosEnPantalla) ====
...
btnGrabar.addEventListener('click', async () => {
    ...
    await ref.set(JSON.parse(JSON.stringify(datosEnPantalla)), { merge: false });
